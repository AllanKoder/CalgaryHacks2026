...
class AIAnalysisResult:
    ...
    is_improvement: (
        bool  # True = user did well / practiced. False = user made a mistake.
    )
...
class UserScores:
    ...
    label_scores: dict[Label, float] = field(
        default_factory=lambda: {label: DEFAULT_SCORE for label in Label}
    )
    ...
    initial_report: str | None = None  # Qualitative summary from AI
