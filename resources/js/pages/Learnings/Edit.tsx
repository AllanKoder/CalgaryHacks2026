...
import { update as eventsLearningUpdate } from '@/routes/events/learning';
...
export default function Edit({ event, learning }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        action_plan: learning.action_plan,
        next_time_strategy: learning.next_time_strategy || '',
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-4">
                <h1 className="text-2xl font-bold">Edit Learning & Action Plan</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Update your action plan</CardDescription>
                        </CardHeader>
