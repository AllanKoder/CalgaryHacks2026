...
import { store as eventsGoalStore } from '@/routes/events/goal';
...
export default function Create({ event }: Props) {
    ...
    function handleSubmit(e: React.FormEvent) {
        e.preventDefault();
        post(eventsGoalStore(event.id).url);
    }
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Set your improvement goal for this event</CardDescription>
                        </CardHeader>
