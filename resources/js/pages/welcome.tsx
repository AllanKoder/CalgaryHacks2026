                    ...
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            ...
                            <p className="mb-6 text-lg text-[#706f6c] dark:text-[#A1A09A]">
                                Transform experiences into learning through structured reflection
                            </p>
                            <div className="mb-6 space-y-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h3 className="font-semibold">What? — Document Your Experience</h3>
                                        <p className="text-[#706f6c] dark:text-[#A1A09A]">Capture moments that matter for growth</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h3 className="font-semibold">So What? — Reflect & Analyze</h3>
                                        <p className="text-[#706f6c] dark:text-[#A1A09A]">Identify patterns, assumptions, and insights</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h3 className="font-semibold">Now What? — Plan Forward</h3>
                                        <p className="text-[#706f6c] dark:text-[#A1A09A]">Create actionable strategies for next time</p>
                                    </div>
                                </div>
                            </div>
                            <p className="mb-6 text-sm italic text-[#706f6c] dark:text-[#A1A09A]">
                                Based on Terry Borton's reflective practice framework and experiential learning theory
                            </p>
